...
export const metadata: Metadata = {
  title: 'Geetansh | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Geetansh Goyal! Built using TypeScript, Next.js 14, Framer Motion and Tailwind CSS.',
};
