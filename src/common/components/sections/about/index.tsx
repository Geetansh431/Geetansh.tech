          ...
          <div className="antialiased group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              <div className="flex h-full flex-col justify-center gap-6">
                <span>
                  I'm a versatile software developer with strong expertise in C++, Java, and MySQL, along with a passion for problem-solving and algorithmic challenges. I have experience building user-centric digital experiences across Android, web, and desktop platforms.
                </span>
                <span>
                  I am seeking opportunities in software development where I can leverage my skills in full-stack development, competitive programming, and machine learning to create innovative and impactful solutions that connect products with users.
                </span>
